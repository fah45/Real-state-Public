            ...
            <div className="card card-compact  transition border-2  hover:scale-100 md:hover:scale-105 lg:hover:scale-105 border-opacity-30 border-green-500 hover:border-green-700  group hover:no-underline focus:no-underline bg-base-100 shadow-xl">
                ...
                <div className="card-body items-center text-center">
                    ...
                    <div className="card-actions">
                        <Link to={'/public/example.json'} className="btn text-white bg-green-700 hover:bg-green-800 focus:outline-none focus:ring-4 focus:ring-green-300 font-medium rounded-full text-sm px-5 py-2.5 text-center me-2 mb-2 dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800"><button>View Property</button></Link>
                    </div>
                </div>
            </div>
        </div >
